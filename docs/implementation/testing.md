...
> **Current status:** **989 tests passing** in the Dart layer (run `flutter test` for
...
**Test Coverage:** 989 tests passing in the Dart layer; **no automated native tests yet**
