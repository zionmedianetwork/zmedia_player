...
> **Current status:** **1044 tests passing** in the Dart layer (run `flutter test` for
...
**Test Coverage:** 1044 tests passing in the Dart layer; **no automated native tests yet**
