...
> **Current status:** **958 tests passing** in the Dart layer (run `flutter test` for
...
**Test Coverage:** 958 tests passing in the Dart layer; **no automated native tests yet**
