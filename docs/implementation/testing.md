...
> **Current status:** **933 tests passing** in the Dart layer (run `flutter test` for
...
**Test Coverage:** 933 tests passing in the Dart layer; **no automated native tests yet**
