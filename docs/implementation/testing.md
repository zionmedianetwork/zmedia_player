...
> **Current status:** **1030 tests passing** in the Dart layer (run `flutter test` for
...
**Test Coverage:** 1030 tests passing in the Dart layer; **no automated native tests yet**
