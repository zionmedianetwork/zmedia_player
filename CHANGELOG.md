...
- 🐛 fix(example): clarify AirPlay discovery is via native route picker on iOS (@Adolphe Cher-Aime) (202b461)
- 🐛 fix(ios): re-attach AVPlayerLayer on foreground to fix grey surface after standby (@Adolphe Cher-Aime) (70a8022)
- 🐛 fix(ios): forward signed cookies via AVURLAssetHTTPCookiesKey to stop intermittent live 403s (@Adolphe Cher-Aime) (3902f67)
...
- Merge pull request #60 from zionmedianetwork/fix/ios-live-signed-cookies-and-standby-reattach (@Adolphe Cher-Aime) (e6b6100)
- ci: auto-merge the version-bump PR via RELEASE_PAT so main never lags (@Adolphe Cher-Aime) (6d50c3b)
- ci: make README version badge self-updating from latest GitHub release (@Adolphe Cher-Aime) (5bc47e4)
...
**Full Changelog**: https://github.com/zionmedianetwork/zmedia_player/compare/v0.1.0...v0.2.4
