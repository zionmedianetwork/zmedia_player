...
[![Tests](https://img.shields.io/badge/tests-1070%20passing-brightgreen.svg)](docs/summary/test-coverage.md)
...
`flutter analyze` clean and `flutter test` green (currently 1070), and open a PR.
...
- **Tests:** 1070 automated tests — run `flutter test` for the current count.
