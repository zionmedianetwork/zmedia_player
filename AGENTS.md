...
- Run `flutter analyze` (clean) and `flutter test` (keep green — run it for the current count) before proposing changes; if you touched `example/`, also run `cd example && flutter test` (24 tests as of this writing).
